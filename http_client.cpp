...
// Send UPDATE request
std::string HTTPClient::update(const std::string& url, const std::string& data) {
...
std::string HTTPClient::sendRequest(const std::string& url, const std::string& requestType, const std::string& data) {
...
std::string HTTPClient::buildRequest(const std::string& url, const std::string& requestType, const std::string& data) {
